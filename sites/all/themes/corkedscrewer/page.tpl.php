...
<div class="slider-item-body">Man that sounds dirty...</div>
</div>
<!--EOF:slider-item-->
...
<div class="slider-item-body">Can be pompous asses</div>
</div>
<!--EOF:slider-item-->
...
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img1.png"/></div>
<div class="slider-item-title light">Eat food</div>
<div class="slider-item-body">Food is good</div>
</div>
<!--EOF:slider-item-->
...
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img1.png"/></div>
<div class="slider-item-title">Beer </div>
<div class="slider-item-body">Don't forget about beer!</div>
</div>
<!--EOF:slider-item-->
</div>
<!--EOF:slides-->
